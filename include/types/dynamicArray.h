...
extern "C"
{
	...
	/**
	 * @brief allocate to buffers in newAllocator copy the array and it's data up to currentSize to them and the free the original.
	 * 			also set allocator to newAllocator.
	 */
